...
<html>
	<head>
        ...
        <link rel="stylesheet" href="css/jquery-jvectormap/jquery-jvectormap-1.2.2.css" />
	...
	<body class="fixed">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="sub-nav">
                            ...
                            <ul class="sub-menu">
                                <li><a href="dashboard.php?p=all-user">All users</a></li>
                                <li><a href="dashboard.php?p=add-user">Add user</a></li>
                            </ul>
                        </li>
                         ...
                         <li class="sub-nav">
                            ...
                            <ul class="sub-menu">
                                <li><a href="dashboard.php?p=all-posts">All posts</a></li>
                                <li><a href="dashboard.php?p=add-post">Add new post</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="sub-nav">
                            ...
                            <ul class="sub-menu">
                                <li><a href="dashboard.php?p=all-categories">All categories</a></li>
                                <li><a href="dashboard.php?p=add-category">Add new category</a></li>
                            </ul>
                        </li>
		...
		<script src="js/plugins/flot/jquery.flot.stack.min.js" type="text/javascript"></script>
		<script src="js/plugins/flot/jquery.flot.crosshair.min.js" type="text/javascript"></script>
        <script src="js/plugins/jquery-jvectormap/jquery-jvectormap-1.2.2.min.js" type="text/javascript"></script>
        <script src="js/plugins/jquery-jvectormap/jquery-jvectormap-europe-merc-en.js" type="text/javascript"></script>
		
		<!-- Interface -->
        <script src="js/plugins/jquery-countTo/jquery.countTo.js" type="text/javascript"></script>

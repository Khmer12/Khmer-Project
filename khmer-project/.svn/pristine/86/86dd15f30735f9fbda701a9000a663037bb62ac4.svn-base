...
<html>
	...
	<body class="fixed">
        ...
        <div class="wrapper">
                ...
                <div class="sidebar">
                    ...
                    <ul class="sidebar-menu">
						...
						<li class="active sub-nav">
                            ...
                            <ul class="sub-menu">
                                <li class="active"><a href="flot.php">Flot</a></li>
            ...
            <div class="rightside">
                <div class="page-head">
                    <h1>Flot  <small>small text goes here</small></h1>
                    <ol class="breadcrumb">
						<li>You are here:</li>
                        <li>Charts</li>
				...
				<div class="row">
                        <div class="col-md-6">
                            <div class="box">
                                ...
                                <div class="box-body">
                                    <div class="flot">
										<div class="flot-placeholder" id="flot-bar-chart"></div>
									</div>
                                </div>
                            </div><!-- /.box -->

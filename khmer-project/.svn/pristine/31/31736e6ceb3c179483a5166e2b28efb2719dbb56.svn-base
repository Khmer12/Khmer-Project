					...
					<div class="col-md-12">
						...
						<table class="shopping-cart">
							...
							<tr>
								...
								<td class="image"><a href="page-product-details.php"><img src="img/product1.jpg" alt="Item Name"></a></td>
								<!-- Shopping Cart Item Description & Features -->
								<td>
									<div class="cart-item-title"><a href="page-product-details.php">LOREM IPSUM DOLOR</a></div>
							...
							<tr>
								<td class="image"><a href="page-product-details.php"><img src="img/product2.jpg" alt="Item Name"></a></td>
								<td>
									<div class="cart-item-title"><a href="page-product-details.php">LOREM IPSUM DOLOR</a></div>
									<div class="feature color">
							...
							<tr>
								<td class="image"><a href="page-product-details.php"><img src="img/product3.jpg" alt="Item Name"></a></td>
								<td>
									<div class="cart-item-title"><a href="page-product-details.php">LOREM IPSUM DOLOR</a></div>
									<div class="feature color">
									</div>

...
<html>
	...
	<body class="fixed">
        ...
        <div class="wrapper">
                    ...
                    <ul class="sidebar-menu">
                        ...
                        <li class="active sub-nav">
                            ...
                            <ul class="sub-menu">
                                ...
                                <li class="active"><a href="form-validation.php">Form Validation</a></li>
                            </ul>
                        </li>
                        <li class="sub-nav">
                            <a href="#">
            ...
            <div class="rightside">
                <div class="page-head">
                    <h1>Form Validation  <small>small text goes here</small></h1>
                    <ol class="breadcrumb">
						<li>You are here:</li>
                        <li>Forms</li>
							...
							validators: {
								callback: {
									...
									callback: function(value, validator) {
										var items = $('#captchaOperation').php().split(' '), sum = parseInt(items[0]) + parseInt(items[2]);
										return value == sum;
									}
								}
							}

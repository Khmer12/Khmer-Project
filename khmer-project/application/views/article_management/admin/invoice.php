...
<html>
	...
	<body class="fixed">
        ...
        <div class="wrapper">
            ...
            <div class="rightside">
                <div class="page-head">
                    <h1>Invoice <small>small text goes here</small></h1>
                    <ol class="breadcrumb">
						<li>You are here:</li>
				 ...
				 <div class="row">
					<div class="col-md-12">
						...
						<div class="invoice-title">
							<h3><i class="fa fa-bolt"></i> Maniac, Inc.</h3><h4 class="pull-right">Order # 12345</h4>
						</div>
						<hr>
						<div class="row">
							<div class="col-xs-6">
						...
						<div class="row">
							...
							<div class="box-footer padding-md">
								...
								<button class="btn btn-success pull-right" style="margin-left: 5px;"><i class="fa fa-credit-card"></i> Submit Payment</button>  

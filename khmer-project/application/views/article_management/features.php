        ...
        <div class="mainmenu-wrapper">
	        <div class="container">
	        	<div class="menuextras">
					<div class="extras">
						<ul>
							<li class="shopping-cart-items"><i class="icon-shopping-cart icon-white"></i> <a href="page-shopping-cart.php"><b>3 items</b></a></li>
							<li>
							...
							<div class="mainmenu-submenu">
								<div class="mainmenu-submenu-inner"> 
									<div>
										...
										<ul>
											<li><a href="page-services-1-column.php">Services/Features (1 Column)</a></li>
